...
\small
\begin{tabular}{ cc   }	
\specialcell{\includegraphics[scale=0.5]{sorted_standard_grain_ratio_negative.png}  }	&  
\specialcell{ \includegraphics[scale=0.5]{raw_data_grain_ratio_pair_plot.png}} \\
%\multicolumn{2}{c} {Grains Ratio}
\end{tabular}
\centering
...
\small
\begin{tabular}{ cc }	
\specialcell{\includegraphics[scale=0.45]{pair_plot_fruits_ratio} } & 
\specialcell{ \includegraphics[scale=0.45]{standard_fruit_ratio_mortality.png} } \\
%\multicolumn{2}{c} {Fruits Ratio}
\end{tabular}
\centering
...
\small
\begin{tabular}{ccc}	
\includegraphics[scale=0.45]{standard_vegetable_ratio.png} & 
\includegraphics[scale=0.45]{standard_actual_vegetable_intake_esrd_mortality.png} & 
\includegraphics[scale=0.45]{pairplot_vegetable_.png} 	  \\
%\multicolumn{3}{c} {Vegetables Ratio}
\end{tabular}
\centering
...
\small
\begin{tabular}{ccc}
\specialcell{\includegraphics[scale=0.4]{standard_actual_starchy_vegetable_esrd_mortality.png} } & 
\specialcell{\includegraphics[scale=0.4]{standard_actual_red_and_orange_vegetable_esrd_mortality.png} } & 
 \specialcell{\includegraphics[scale=0.4]{standard_actual_other_vegetable_esrd_mortality.png}	 } \\ 
...
\small
\begin{tabular}{ccc}
\specialcell{ \includegraphics[scale=0.4]{negatively_subgroup_avg_alcohol_intake}  } & 
\specialcell{\includegraphics[scale=0.4]{negatively_added_sugar_subgroup_line_2}  } &
\specialcell{ \includegraphics[scale=0.4]{negatively_avg_nuts_subgroup_line_3}  } \\
Alcohol & Sugar & Nuts \\
\end{tabular}
\centering
...
\small
\begin{tabular}{ccc}
\specialcell{ \includegraphics[scale=0.4]{pairplot_avg_alc.png}} & 
\specialcell{\includegraphics[scale=0.4]{pairplot_raw_data_added_sugar_esrd}  } &
\specialcell{\includegraphics[scale=0.4]{pairplot_nuts_avg_negative.png} } \\
Alcohol & Sugar & Nuts \\
\end{tabular}
\centering
\caption{Food Subgroups  and Mortality - Negative Correlations}
