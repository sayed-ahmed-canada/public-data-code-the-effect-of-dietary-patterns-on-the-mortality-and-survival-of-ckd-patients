...
\hline
\hline
\specialcell{\includegraphics[scale=0.3]{sorted_standard_grain_ratio_negative.png} \\ Grains }	&  \specialcell{ \includegraphics[scale=0.35]{raw_data_grain_ratio_pair_plot.png}\\ Grains } \\
\hline
\hline
\specialcell{\includegraphics[scale=0.35]{pair_plot_fruits_ratio} \\ Fruits} & \specialcell{ \includegraphics[scale=0.30]{standard_fruit_ratio_mortality.png} \\ Fruits} \\
\hline
\end{tabular}
\end{figure}
\end{center}
...
\begin{tabular}{|c| c|c|}	
	\hline
	\includegraphics[scale=0.35]{standard_vegetable_ratio.png} & 
	\includegraphics[scale=0.35]{standard_actual_vegetable_intake_esrd_mortality.png} & 
...
\begin{tabular}{|c|c|c|}
        \hline	
	\specialcell{\includegraphics[scale=0.35]{standard_actual_starchy_vegetable_esrd_mortality.png} \\ Starchy Vegetables} & 
	\specialcell{\includegraphics[scale=0.35]{standard_actual_red_and_orange_vegetable_esrd_mortality.png} \\ Red and Orange Vegetables} & 
	 \specialcell{\includegraphics[scale=0.35]{standard_actual_other_vegetable_esrd_mortality.png}	 \\ Other Vegetables} \\
	 \hline
\end{tabular}
\end{figure}
\end{center}
...
\begin{tabular}{|c|c|c|}
\hline	
	\specialcell{ \includegraphics[scale=0.35]{negatively_subgroup_avg_alcohol_intake} \\ Alcohol } & 
	\specialcell{\includegraphics[scale=0.35]{negatively_added_sugar_subgroup_line_2} \\ Sugar } &
	\specialcell{ \includegraphics[scale=0.35]{negatively_avg_nuts_subgroup_line_3} \\ Nuts } \\
	\hline
	\specialcell{ \includegraphics[scale=0.35]{pairplot_avg_alc.png} \\ Alcohol} & 
	\specialcell{\includegraphics[scale=0.35]{pairplot_raw_data_added_sugar_esrd} \\ Sugar } &
	\specialcell{\includegraphics[scale=0.35]{pairplot_nuts_avg_negative.png} \\ Nuts } \\
	\hline
\end{tabular}
\end{figure}
\end{center}
...
\begin{center}
\begin{table}
\caption{Outcome when ACR Values are used as the Target}
\vspace{0.25cm}
\small
